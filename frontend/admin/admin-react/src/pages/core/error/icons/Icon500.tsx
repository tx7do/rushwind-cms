...
const ServerDownIcon = () => {
    return (
        ...
        >
            ...
            <circle cx="292.60911" cy="213" fill="var(--fb-mist)" r="213" />
            <path
                d="M31.39089,151.64237c0,77.49789,48.6181,140.20819,108.70073,140.20819"
                fill="var(--fb-navy-deep)"
            ...
            <path
                ...
                transform="translate(-31.39089 -100.5)"
            />
            <ellipse cx="198.60911" cy="424.5" fill="var(--fb-navy)" rx="187" ry="25.43993" />
            <ellipse cx="198.60911" cy="424.5" opacity={0.1} rx="157" ry="21.35866" />
            <ellipse cx="836.60911" cy="660.5" fill="var(--fb-navy)" rx="283" ry="38.5" />
            <ellipse cx="310.60911" cy="645.5" fill="var(--fb-navy)" rx="170" ry="23.12721" />
            <path
                d="M494,726.5c90,23,263-30,282-90"
                fill="none"
                stroke="var(--fb-navy-deep)"
                strokeMiterlimit={10}
                strokeWidth={2}
                transform="translate(-31.39089 -100.5)"
            />
            ...
            <rect
                ...
                y="231.77652"
            />
            <circle cx="835.05948" cy="223.29299" fill="var(--fb-mist)" r="3.02983" />
            <path
            ...
            <ellipse
                ...
                ry="2.42386"
            />
            <circle cx="835.05948" cy="545.66686" fill="var(--fb-mist)" r="11.51335" />
            <polygon
                opacity={0.1}
                points="968.978 667.466 968.978 673.526 642.968 673.526 642.968 668.678 643.417 667.466 968.978 667.466"
            />
            <rect fill="var(--fb-navy-deep)" height="242" width="208" x="108.60911" y="159" />
            <rect fill="var(--fb-navy)" height="86" width="250" x="87.60911" y="135" />
            <rect fill="var(--fb-navy)" height="86" width="250" x="87.60911" y="237" />
            <rect fill="var(--fb-navy)" height="86" width="250" x="87.60911" y="339" />
            <rect
                fill="var(--fb-primary)"
                height={16}
                opacity={0.4}
            ...
            <rect
                ...
                y="150"
            />
            <rect fill="var(--fb-primary)" height={16} width={16} x="317.60911" y="150" />
            <rect
                fill="var(--fb-primary)"
                height={16}
                opacity={0.4}
            ...
            <rect
                ...
                y="251"
            />
            <rect fill="var(--fb-primary)" height={16} width={16} x="317.60911" y="251" />
            <rect
                fill="var(--fb-primary)"
                height={16}
                opacity={0.4}
            ...
            <rect
                ...
                y="352"
            />
            <rect fill="var(--fb-primary)" height={16} width={16} x="317.60911" y="352" />
            <circle cx="316.60911" cy="538" fill="var(--fb-navy-deep)" r="79" />
            <rect fill="var(--fb-navy-deep)" height={43} width={24} x="280.60911" y="600" />
            <rect fill="var(--fb-navy-deep)" height={43} width={24} x="328.60911" y="600" />
            <ellipse cx="300.60911" cy="643.5" fill="var(--fb-navy-deep)" rx="20" ry="7.5" />
            <ellipse cx="348.60911" cy="642.5" fill="var(--fb-navy-deep)" rx="20" ry="7.5" />
            <circle cx="318.60911" cy="518" fill="var(--fb-paper)" r="27" />
            <circle cx="318.60911" cy="518" fill="var(--fb-navy)" r="9" />
            <path
